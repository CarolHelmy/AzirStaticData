        ...
        <div className="segment-footer">
          ...
          <div className="footer-item footer-categories">
            ...
            <ul className="footer-links">
              <li className="footer-link">
                <Link to="/shop">Computer & Laptop</Link>
              </li>
              <li className="footer-link">
                <Link to="/shop">Smartphone</Link>
              </li>
              <li className="footer-link">
                <Link to="/shop">Headphone</Link>
              </li>
              <li className="footer-link">
                <Link to="/shop">Accessories</Link>
              </li>
              <li className="footer-link">
                <Link to="/shop">Camera & Photo</Link>
              </li>
              <li className="footer-link">
                <Link to="/shop">TV & Homes</Link>
              </li>
            </ul>
          ...
          <div className="footer-item footer-qlinks">
            ...
            <ul className="footer-links">
              ...
              <li className="footer-link">
                <Link to="/support">customer help</Link>
              </li>
              <li className="footer-link">
